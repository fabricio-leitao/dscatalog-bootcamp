...
public class ProductResourceTests {
	...
	@Test
	public void updateShouldReturnProductDTOWhenIdDExistis() throws Exception {
	...
	public void findByIdShouldReturnProductWhenIdExists() throws Exception {
		...
		mockMvc.perform(get("/products/{id}", existingId)
				.accept(MediaType.APPLICATION_JSON))
		.andExpect(status().isOk()).andExpect(jsonPath("$.id").exists()).andExpect(jsonPath("$.id").value(existingId));

	}
	
	@Test
	public void findByIdShouldReturnNotFoundWhenNotExist() throws Exception {
